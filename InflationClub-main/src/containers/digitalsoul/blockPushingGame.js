const floor = new Array(9).fill(new Array(9).fill('X'))
        ...
        Promise.allSettled([
        loadTexture('https://dev-to-uploads.s3.amazonaws.com/uploads/articles/t8m6p3ja3uglqkj7mr5p.jpg'),
        loadTexture('https://dev-to-uploads.s3.amazonaws.com/uploads/articles/kvk9f4hv36aiaf0gafuj.jpg'),
        loadTexture('https://dev-to-uploads.s3.amazonaws.com/uploads/articles/mx57yo1h4k0np8f0vd4e.jpg'),
        loadTexture('https://dev-to-uploads.s3.amazonaws.com/uploads/articles/irf6xxiac4msxx7910mz.jpg'),
        loadTexture('https://dev-to-uploads.s3.amazonaws.com/uploads/articles/uqw1byqe0e50lotst5vn.png'),
        ]).then(results => {
        const [
            floorTexture,
            wallTexture,
